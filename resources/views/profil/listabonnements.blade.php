...
@section('content')
    <div class="container">
        ...
        <h2 class="text-center mb-3">Liste des abonnements de <a href="{{ route('profilShow', $user['id']) }}"><img src="{{URL::asset($user['avatar'])}}" class="rounded-circle avat-min"> {{ __('@') }}{{$user['name']}}</a></h2>
